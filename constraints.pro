...
repo_name(RepoUrl, RepoName) :-
  Prefix = 'https://github.com/mcmire/',
...
gen_enforced_field(WorkspaceCwd, 'homepage', CorrectHomepageUrl) :-
  ...
  repo_name(RepoUrl, RepoName),
  atomic_list_concat(['https://github.com/mcmire/', RepoName, '#readme'], CorrectHomepageUrl).
...
gen_enforced_field(WorkspaceCwd, 'bugs.url', CorrectBugsUrl) :-
  ...
  workspace_field(WorkspaceCwd, 'repository.url', RepoUrl),
  repo_name(RepoUrl, RepoName),
  atomic_list_concat(['https://github.com/mcmire/', RepoName, '/issues'], CorrectBugsUrl).
...
gen_enforced_field(WorkspaceCwd, 'repository.url', 'https://github.com/mcmire/<insert repo name here>.git') :-
  workspace_field(WorkspaceCwd, 'repository.url', RepoUrl),
  \+ repo_name(RepoUrl, _).
